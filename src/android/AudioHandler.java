...
public class AudioHandler extends CordovaPlugin {
    ...
    private CallbackContext interruptionChannel;
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("startRecordingAudio")) {
           ...
           try {
            ...
            callbackContext.sendPluginResult(new PluginResult(status, f));
            return true;
        } else if (action.equals("androidHandleInterruption")) {
            interruptionChannel = callbackContext;
            return true;
    ...
    private OnAudioFocusChangeListener focusChangeListener = new OnAudioFocusChangeListener() {
            public void onAudioFocusChange(int focusChange) {
                ...
                case (AudioManager.AUDIOFOCUS_LOSS) :
                    pauseAllLostFocus();
                    PluginResult prF = new PluginResult(PluginResult.Status.OK, "cdv-sound-audiofocusloss");
                    prF.setKeepCallback(true);
                    interruptionChannel.sendPluginResult(prF);
                    break;
                case (AudioManager.AUDIOFOCUS_GAIN):
                    resumeAllGainedFocus();
                    PluginResult prG = new PluginResult(PluginResult.Status.OK, "cdv-sound-audiofocusgain");
                    prG.setKeepCallback(true);
                    interruptionChannel.sendPluginResult(prG);
                    break;
                default:
                    break;
                }
